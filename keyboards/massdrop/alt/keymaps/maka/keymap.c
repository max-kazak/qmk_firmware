...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,         TD(EXLM_1),    TD(AT_2),       TD(HASH_3),     TD(DLR_4),  TD(PERC_5), TD(CIRC_6), TD(AMPR_7), TD(ASTR_8),     KC_9,        KC_0,           KC_MINS,      KC_EQL , KC_BSPC, KC_DEL,  \
    ...
    [1] = LAYOUT(
        ...
        _______,        KC_P1  ,       KC_P2  ,        KC_P3  ,        KC_PDOT,    _______,    _______,    KC_MUTE,    _______,        KC_DOT ,     _______,        KC_PAUS,               _______, KC_VOLD, \
...
led_instruction_t led_instructions[] = {
    ...
    //All LEDs use the user's selected pattern (this is the factory default)
     ...
     //numpad
     { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER| LED_FLAG_USE_RGB, .id0 = 2147942400, .id1 = 268558339, .r = 33, .g =150, .b = 200, .layer = 1},
     //numpad ops
     { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER| LED_FLAG_USE_RGB, .id0 = 1075314688, .id1 = 12, .r = 0, .g =0, .b = 255, .layer = 1},
     //media
     { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER| LED_FLAG_USE_RGB, .id0 = 33554432, .id1 = 42469376, .r = 76, .g =255, .b = 80, .layer = 1},
     //led control
     ...
     //rest
     { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER| LED_FLAG_USE_RGB, .id0 = 1006690305, .id1 = 3983546112, .id2 = 7, .r = 255, .g =255, .b = 255, .layer = 1},
     //backlight
